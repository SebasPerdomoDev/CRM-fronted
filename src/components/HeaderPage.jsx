        ...
        <div className="mb-2 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4 ml-auto relative bg-white px-4 py-2 shadow-md rounded-2xl">
            <div className="text-sm">
              <h1 className="text-main-blue font-bold">Juan</h1>
              <p className="text-gray-600 text-sm">CEO</p>
            </div>
            <div className="w-12 h-12 rounded-full cursor-pointer flex items-center justify-center bg-main-blue text-white text-xl font-bold">
